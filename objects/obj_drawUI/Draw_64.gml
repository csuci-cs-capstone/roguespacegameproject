...
var subImage = ceil((obj_player.currentHealth * 25) / obj_player.maxHealth)
if subImage < 0
{
	subImage = 0	
}
draw_sprite_ext(spr_health, subImage, 8 * view_wport[0]/640, 8 * view_hport[0]/360, view_wport[0]/640, view_hport[0]/360, 0, c_white, 1)
